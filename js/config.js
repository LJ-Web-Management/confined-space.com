...
var courses = [
    ...
    {id: 407, code: 'entry', name: 'Permit-Required Entry', price: 59.99},
    {id: 419, code: 'supervisor', name: 'Confined Space Supervisor', price: 69.99},
    {id: 353, code: 'competent', name: 'Competent Person', price: 159.99},
];

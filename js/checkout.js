document.addEventListener('DOMContentLoaded', function () {
  ...
  if (stripeCheckoutForm) {
    ...
    var courseParam = urlParams.get('course') || 'awareness';
    ...
    // Google Places address autocomplete is intentionally not wired up on this site
    // (no Google Maps API key is loaded here) — the address fields work as plain text input.
    ...
    stripeCheckoutForm.addEventListener('submit', async function (e) {
      ...
      var orderId = 'CST-' + Math.floor(100000 + Math.random() * 900000);
      try {
        var orderPayload = {
          ...
          order_form: 'confined-space.com',
          order_from: 'confined-space.com',
          ...
          courses: [
            {
              course_id: currentOrderDetails ? currentOrderDetails.courseId : 100,
      ...
      // STEP 3: Render Order Confirmation View ONLY after complete success
